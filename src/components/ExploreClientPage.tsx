...
import SjLoader from '@/components/SjLoader'; // ✅ Imported your official loader
...
export default function ExploreClientPage() {
    ...
    const getKey = (pageIndex: number, previousPageData: any) => {
        ...
        const params = new URLSearchParams({
            ...
            sort: sort // ✅ Tells backend which section is active
        });
    ...
    return (
        <div className="explore-container">
            ...
            <header className="explore-header animated-aurora">
                <div className="header-glass-content">
                    ...
                    <div className="controls-bar">
                        {/* ✅ FIXED: Beautiful solid tabs that look great on Mobile and Desktop */}
            ...
            <main className="explore-main-content">
                ...
                {/* ✅ FIXED: Replaced standard spinner with SJ Loader for infinite scroll */}
            ...
            <style jsx>{`
                ...
                .explore-header {
                    position: relative; width: 100%; overflow: hidden; margin-bottom: 24px;
                ...
                .header-glass-content {
                    ...
                    backdrop-filter: blur(20px); padding: 24px 0 10px;
                    display: flex; flex-direction: column; gap: 20px;
                }

                .header-top { display: flex; justify-content: center; align-items: center; }
                .title-wrapper { text-align: center; }
                .title-wrapper h2 { font-size: 28px; font-weight: 800; color: #0f172a; margin: 0; letter-spacing: -0.5px; }
                ...
                .search-hero { display: flex; flex-direction: column; align-items: center; gap: 12px; }
                .search-box-wrapper { position: relative; width: 100%; max-width: 650px; transform: translateZ(0); }
                .search-icon { position: absolute; left: 18px; top: 50%; transform: translateY(-50%); color: #64748b; z-index: 2; }
                .search-box-wrapper input {
                    width: 100%; height: 56px; padding: 0 20px 0 54px; border-radius: 16px; border: 2px solid transparent;
                    background: #fff; box-shadow: 0 4px 20px rgba(0, 0, 0, 0.08);
                    font-size: 16px; font-weight: 500; color: #1e293b; transition: all 0.25s;
                }
                .search-box-wrapper input:focus { outline: none; border-color: #3b82f6; box-shadow: 0 8px 30px rgba(59, 130, 246, 0.2); transform: translateY(-2px); }

                .quick-tags { display: flex; gap: 8px; flex-wrap: wrap; justify-content: center; font-size: 13px; color: #64748b; }
                .quick-tags span { font-weight: 600; }
                .quick-tags button { background: rgba(0,0,0,0.03); border: none; padding: 4px 10px; border-radius: 20px; color: #334155; cursor: pointer; transition: all 0.2s; font-size: 12px; }
                ...
                .neon-ring-wrapper.active .neon-spinner { background: conic-gradient(from 0deg, #ec4899 0%, #8b5cf6 100%); opacity: 1; padding: 4px; }
                ...
                /* ✅ NEW TAB STYLES (Looks great on Mobile) */
                .tabs-container { display: flex; gap: 10px; }
                .tab-btn {
                    background: #f1f5f9; border: 1px solid transparent; font-size: 14px; font-weight: 600;
                    color: #64748b; cursor: pointer; padding: 10px 20px; border-radius: 12px;
                    transition: all 0.3s;
                }
