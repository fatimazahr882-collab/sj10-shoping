...
export default function CategorySlugPage() {
    ...
    const fetchData = useCallback(async (pageNum: number, isRefresh: boolean) => {
        ...
        try {
            ...
            // Client-Side Refinement (Optional if API doesn't handle these)
            if (isVerified) {
            ...
            setHasMore(pageNum < totalPages && fetchedProducts.length > 0);
    ...
    // Trigger Fetch on mount or filter change
    useEffect(() => {
        setPage(1);
        fetchData(1, true);
    }, [fetchData]);
    ...
    return (
        <div className="page-wrapper">
            ...
            <style jsx>{`
                ...
                /* I am keeping the styles implicit to save space, paste your style block here */
                .page-wrapper {
            ...
            <main>
                <div className="grid">
                    {loading ? (
                        // Skeleton Loader inside the grid
